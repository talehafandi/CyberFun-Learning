...
const restApi = {
  ...
  getDataOnLeaderboard: () => makeApiCall("/", "GET", null, null), //! Change the order of arguments and pass null for parameters not used
  getDataOnLevels: () => makeApiCall("/", "GET", null, null),
};
